...
# btn1.pack(side='left')
# btn2.pack(side='right') # pack은 쌓는 개념이다.
...
btn_slasch = Button(root, text='/', width=5, height=2)
btn_star = Button(root, text='*', width=5, height=2)

btn_clear.grid(row=1, column=0, sticky=N+E+W+S, padx=3, pady=3)
btn_equal.grid(row=1, column=1, sticky=N+E+W+S, padx=3, pady=3)
btn_slasch.grid(row=1, column=2, sticky=N+E+W+S, padx=3, pady=3)
